...
int main(){
	...
	/*load model*/
	std::shared_ptr<torch::jit::script::Module> module = torch::jit::load("D:\\data\\tanglin\\maskrcnn_c++\\model_gpu_0.5.pt");
	...
	cv::String folder = "D:\\data\\tanglin\\maskrcnn_c++\\pict_n"; //images folder
	//cv::String save_folder = "D:\\data\\tanglin\\maskrcnn_c++\\result\\川大\\"; //save folder
	cv::String save_folder = "D:\\data\\tanglin\\maskrcnn_c++\\result\\pict_n\\"; //save folder
	...
	for (int i = 0; i<filenames.size(); ++i) {
		...
		cout << txtfile1 + txtname[0] + hz << endl;
